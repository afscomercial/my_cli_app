...
export const webhooksApril20 = [
  ...
  { name: 'COLLECTIONS_LISTINGS_CREATE', route: '/webhooks/collections-listings/create', apiVersion: ApiVersion.April20 },
  { name: 'COLLECTIONS_LISTINGS_DELETE', route: '/webhooks/collections-listings/delete', apiVersion: ApiVersion.April20 },
  { name: 'COLLECTIONS_LISTINGS_UPDATE', route: '/webhooks/collections-listings/update', apiVersion: ApiVersion.April20 },
  ...
  { name: 'CUSTOMERS_GROUPS_CREATE', route: '/webhooks/customers-groups/create', apiVersion: ApiVersion.April20 },
  { name: 'CUSTOMERS_GROUPS_DELETE', route: '/webhooks/customers-groups/delete', apiVersion: ApiVersion.April20 },
  { name: 'CUSTOMERS_GROUPS_UPDATE', route: '/webhooks/customers-groups/update', apiVersion: ApiVersion.April20 },
  ...
  { name: 'INVENTORY_LEVELS_CONNECT', route: '/webhooks/inventory-levels/connect', apiVersion: ApiVersion.April20 },
  { name: 'INVENTORY_LEVELS_DISCONNECT', route: '/webhooks/inventory-levels/disconnect', apiVersion: ApiVersion.April20 },
  { name: 'INVENTORY_LEVELS_UPDATE', route: '/webhooks/inventory-levels/update', apiVersion: ApiVersion.April20 },
  ...
  { name: 'ORDERS_PARTIALLY_FULFILLED', route: '/webhooks/orders/partially-fulfilled', apiVersion: ApiVersion.April20 },
  { name: 'ORDERS_UPDATED', route: '/webhooks/orders/updated', apiVersion: ApiVersion.April20 },
  { name: 'ORDERS_TRANSACTIONS_CREATE', route: '/webhooks/orders-transactions/create', apiVersion: ApiVersion.April20 },
  { name: 'PRODUCT_LISTINGS_ADD', route: '/webhooks/product-listings/add', apiVersion: ApiVersion.April20 },
  { name: 'PRODUCT_LISTINGS_REMOVE', route: '/webhooks/product-listings/remove', apiVersion: ApiVersion.April20 },
  { name: 'PRODUCT_LISTINGS_UPDATE', route: '/webhooks/product-listings/update', apiVersion: ApiVersion.April20 },
