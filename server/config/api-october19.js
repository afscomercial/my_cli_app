...
export const webhooksOctober19 = [
  ...
  { name: 'COLLECTIONS_LISTINGS_CREATE', route: '/webhooks/collections-listings/create', apiVersion: ApiVersion.October19 },
  { name: 'COLLECTIONS_LISTINGS_DELETE', route: '/webhooks/collections-listings/delete', apiVersion: ApiVersion.October19 },
  { name: 'COLLECTIONS_LISTINGS_UPDATE', route: '/webhooks/collections-listings/update', apiVersion: ApiVersion.October19 },
  ...
  { name: 'CUSTOMERS_GROUPS_CREATE', route: '/webhooks/customers-groups/create', apiVersion: ApiVersion.October19 },
  { name: 'CUSTOMERS_GROUPS_DELETE', route: '/webhooks/customers-groups/delete', apiVersion: ApiVersion.October19 },
  { name: 'CUSTOMERS_GROUPS_UPDATE', route: '/webhooks/customers-groups/update', apiVersion: ApiVersion.October19 },
  ...
  { name: 'INVENTORY_LEVELS_CONNECT', route: '/webhooks/inventory-levels/connect', apiVersion: ApiVersion.October19 },
  { name: 'INVENTORY_LEVELS_DISCONNECT', route: '/webhooks/inventory-levels/disconnect', apiVersion: ApiVersion.October19 },
  { name: 'INVENTORY_LEVELS_UPDATE', route: '/webhooks/inventory-levels/update', apiVersion: ApiVersion.October19 },
  ...
  { name: 'ORDERS_PARTIALLY_FULFILLED', route: '/webhooks/orders/partially-fulfilled', apiVersion: ApiVersion.October19 },
  { name: 'ORDERS_UPDATED', route: '/webhooks/orders/updated', apiVersion: ApiVersion.October19 },
  { name: 'ORDERS_TRANSACTIONS_CREATE', route: '/webhooks/orders-transactions/create', apiVersion: ApiVersion.October19 },
  { name: 'PRODUCT_LISTINGS_ADD', route: '/webhooks/product-listings/add', apiVersion: ApiVersion.October19 },
  { name: 'PRODUCT_LISTINGS_REMOVE', route: '/webhooks/product-listings/remove', apiVersion: ApiVersion.October19 },
  { name: 'PRODUCT_LISTINGS_UPDATE', route: '/webhooks/product-listings/update', apiVersion: ApiVersion.October19 },
